...
/**
 *	@brief	虚拟币充值请求简化版,该接口将于下个版本中废弃，建议使用paymentSuccess接口
 *
...
/**
 *	@brief	虚拟币充值请求成功,该接口将于下个版本废弃，建议使用paymentSuccess
 *
...
/**
 *	@brief	虚拟币充值请求，用于只能发起充值请求，无法获取充值完成详情的情形,该接口将于下个版本废弃，建议使用paySuccess
 *
 *	@param 	currencyAmount          现金金额
 *	@param 	currencyType            币种       需要使用ISO4217中规范的3字母代码，如美元USD、人民币CNY等 
 *	@param 	paymentType             支付类型    最多16个字符
