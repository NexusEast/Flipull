...
set COCOS2DX_ROOT=E:\Porjects\Flipull\quick-cocos2d-x\lib\cocos2d-x

echo - config:
echo   ANDROID_NDK_ROOT    = %ANDROID_NDK_ROOT%
echo   QUICK_COCOS2DX_ROOT = E:\Porjects\Flipull\quick-cocos2d-x
...
"%ANDROID_NDK_ROOT%\ndk-build" %ANDROID_NDK_BUILD_FLAGS% NDK_DEBUG=%NDK_DEBUG% %NDK_BUILD_FLAGS% -C %APP_ANDROID_ROOT% NDK_MODULE_PATH=E:\Porjects\Flipull\quick-cocos2d-x;%COCOS2DX_ROOT%;%COCOS2DX_ROOT%\cocos2dx\platform\third_party\android\prebuilt
pause