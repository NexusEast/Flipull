...
namespace dragonBones
{
    ...
    public:
        ...
        virtual void loadTextureAtlasFile(const String &textureAtlasFile, const String &PNGPath , const String &name = "") = 0;
         ...
         */
        Armature* buildArmature(cocos2d::ccBlendFunc blendFunc ,const String &armatureName, const String &animationName = "", const String &skeletonName = "", const String &textureAtlasName = "", const String &skinName = "");
        /**
         ...
         * @return
         */
        virtual Object* generateDisplay(cocos2d::ccBlendFunc blendFunc,ITextureAtlas *textureAtlas, const String &fullName, Number pivotX, Number pivotY);
    };
};
