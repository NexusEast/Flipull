...
** Generated automatically by tolua++-1.0.92 on Tue Apr 22 19:44:16 2014.
*/
...
/* method: setPOSTDataLua of class  CCHTTPRequest */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCHTTPRequest_setPOSTDataLua00
static int tolua_cocos2dx_extra_luabinding_CCHTTPRequest_setPOSTDataLua00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  CCHTTPRequest* self = (CCHTTPRequest*)  tolua_tousertype(tolua_S,1,0);
  CCArray* data = ((CCArray*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'setPOSTDataLua'", NULL);
#endif
  {
   self->setPOSTDataLua(data);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'setPOSTDataLua'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getResponseByteArray of class  CCHTTPRequest */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCHTTPRequest_getResponseByteArray00
static int tolua_cocos2dx_extra_luabinding_CCHTTPRequest_getResponseByteArray00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  CCHTTPRequest* self = (CCHTTPRequest*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getResponseByteArray'", NULL);
#endif
  {
   CCArray* tolua_ret = (CCArray*)  self->getResponseByteArray();
    int nID = (tolua_ret) ? tolua_ret->m_uID : -1;
int* pLuaID = (tolua_ret) ? &tolua_ret->m_nLuaID : NULL;
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getResponseByteArray'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_cocos2dx_extra_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CCHTTPRequest");
   ...
   tolua_function(tolua_S,"setPOSTDataLua",tolua_cocos2dx_extra_luabinding_CCHTTPRequest_setPOSTDataLua00);
   ...
   tolua_function(tolua_S,"getResponseByteArray",tolua_cocos2dx_extra_luabinding_CCHTTPRequest_getResponseByteArray00);
  tolua_endmodule(tolua_S);
