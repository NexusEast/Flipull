...
{    
    ...
    */
    Armature* BaseFactory::buildArmature(cocos2d::ccBlendFunc blendFunc,const String &armatureName, const String &animationName, const String &skeletonName, const String &textureAtlasName, const String &skinName)
    {
        ...
        for(size_t j = 0 ; j < skinData->slotDataList.size() ; j ++)
        {
            ...
            while(i --)
            {
                ...
                if(displayData->type == DisplayData::ARMATURE)
                {
                    ...
                    childArmature = buildArmature(blendFunc, displayData->name, displayDataCopy?displayDataCopy->name:"", _currentDataName, _currentTextureAtlasName);
                    if(childArmature)
                    {
                ...
                {
                    helpArray[i] = generateDisplay(blendFunc, getTextureAtlas(_currentTextureAtlasName), displayData->name, displayData->pivot.x, displayData->pivot.y);
                }
            }
    ...
    */
    Object* BaseFactory::getTextureDisplay(const String &textureName, const String &textureAtlasName, Number pivotX, Number pivotY)
    {
        ...
        if(textureAtlas)
        {
            ...
            return generateDisplay(m_blendFunc,textureAtlas, textureName, pivotX, pivotY);
        }
        return 0;
    }
    ...
    * @return
    */
    Object* BaseFactory::generateDisplay(cocos2d::ccBlendFunc blendFunc,ITextureAtlas *textureAtlas, const String &fullName, Number pivotX, Number pivotY)
    {
        return 0;
    }
}
