...
function SocketTCP:send(__data)
    ...
    echoInfo("::SocketTCP:send self＝%s,r1=%s,r2=%s,r3=%s len__data=%d",tostring(self),tostring(r1),tostring(r2),
        tostring(r3),
        string.len(__data))
end
...
function SocketTCP:close( ... )
    ...
    echoInfo("::SocketTCP:close self＝%s ",tostring(self) )
    local r1,r2,r3 = self.tcp:close();
    echoInfo("::SocketTCP:close self＝%s,r1=%s,r2=%s,r3=%s ",tostring(self),tostring(r1),tostring(r2),
        tostring(r3))
...
function SocketTCP:disconnect()
    ...
    echoInfo("::SocketTCP:disconnect self＝%s,r1=%s,r2=%s,r3=%s ",tostring(self),tostring(r1),tostring(r2),
        tostring(r3))
end
	...
	local __tick = function()
		while true do
    	    ...
    	    if __status == STATUS_CLOSED or __status == STATUS_NOT_CONNECTED then
                print("SocketTCP:_onConnected special state body:", __body, "__status:", __status, "__partial:",
                    __partial)
		    	self:close()
